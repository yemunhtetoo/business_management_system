<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="image">
            ...
            @else 
            <img src="{{url('admin/img/no-image.png')}}" class="img-circle elevation-2" alt="User Image">
            @endif
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <a href="{{url('admin/subadmins')}}" class="nav-link {{$active}}">
                ...
                <p>
                Subadmins
                <span class="right badge badge-danger">Subadmins</span>
                </p>
            </a>
            </li>
            ...
            <a href="{{url('admin/cms-pages')}}" class="nav-link {{$active}}">
                ...
                <p>
                CMS Page
                <span class="right badge badge-danger">CMS</span>
                </p>
            </a>
            </li>
            {{-- <li class="nav-item">
